package com.kzx.bookstore.order.dao;
...
import com.kzx.bookstore.order.domain.OrderItem;
import com.kzx.bookstore.pager.Expression;
import com.kzx.bookstore.pager.PageBean;
import com.kzx.bookstore.pager.PageConstants;
...
public class OrderDao {
	...
	private PageBean<Order> findByCriteria(List<Expression> exprList, int pc) throws SQLException {
		...
		List<Object> params = new ArrayList<Object>();//SQL中有问号，它是对应问号的
